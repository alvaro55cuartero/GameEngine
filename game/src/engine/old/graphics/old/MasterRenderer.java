...
import engine.old.objeto.entities.Entity3D;
import engine.old.objeto.light.AmbientLight;
import engine.old.tools.FileUtils;
...
public class MasterRenderer {
	...
	public static void processTexturedModels(String ruta) {
		String[] partes = FileUtils.readTxt(new File(ruta)).replace("\n", "").split("#");
