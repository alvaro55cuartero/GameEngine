...
public class GUIText {
	 ...
	 *            - the text.
	 * @param fontSize
	 *            - the font size of the text, where a font size of 1 is the default
	 *            size.
	 * @param font
	 *            - the font that this text should use.
	 * @param position
	 *            - the position on the screen where the top left corner of the text
	 *            should be rendered. The top left corner of the screen is (0, 0)
	 *            and the bottom right is (1, 1).
	 * @param maxLineLength
	 *            - basically the width of the virtual page in terms of screen width
	 *            (1 is full screen width, 0.5 is half the width of the screen,
	 *            etc.) Text cannot go off the edge of the page, so if the text is
	 *            longer than this length it will go onto the next line. When text
	 *            is centered it is centered into the middle of the line, based on
	 ...
	 * 
	 * @param vao
	 *            - the VAO containing all the vertex data for the quads on which
